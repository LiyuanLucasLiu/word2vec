...
# echo 'small'
count=0
for IterNum in 20 30 50 70
do
	for resample in 15 30
	do
		for negative in 10 20
		do
			...
			# echo "kl:"
				...
				# ../bin/finalExp -train /shared/data/ll2/CoType/data/intermediate/KBP/train.data -test /shared/data/ll2/CoType/data/intermediate/KBP/eva.data -val /shared/data/ll2/CoType/data/intermediate/KBP/val.data -threads 30 -none_idx 6 -cleng 200 -lleng 500 -negative $negative -resample $resample -ignore_none 0 -iter $IterNum -alpha 0.025 -normL 0 -debug 1 -dropout $dropout -instances 225977 -test_instances 1900 -val_instances 211 -special_none 0 -error_log 1
	#			../bin/finalExp -train /shared/data/ll2/CoType/data/intermediate/KBP/train.data -test /shared/data/ll2/CoType/data/intermediate/KBP/eva.data -val /shared/data/ll2/CoType/data/intermediate/KBP/val.data -threads 30 -none_idx 6 -cleng 100 -lleng 300 -negative $negative -resample $resample -ignore_none 0 -iter $IterNum -alpha 0.025 -normL 0 -debug 1 -dropout $dropout -instances 225977 -test_instances 1900 -val_instances 211 -special_none 0 -useEntropy 0
				# ../bin/finalExp -train /shared/data/ll2/CoType/data/intermediate/KBP/train.data -test /shared/data/ll2/CoType/data/intermediate/KBP/eva.data -val /shared/data/ll2/CoType/data/intermediate/KBP/val.data -threads 30 -NONE_idx 6 -cleng 100 -lleng 300 -negative $negative -resample $resample -ignore_none 0 -iter $IterNum -alpha 0.025 -normL 1 -debug 1 -dropout $dropout -instances 225977 -test_instances 1900 -val_instances 211
				../bin/finalExp -train /shared/data/ll2/CoType/data/intermediate/NYT/train.data -test /shared/data/ll2/CoType/data/intermediate/NYT/eva.data -val /shared/data/ll2/CoType/data/intermediate/NYT/val.data -threads 30 -none_idx 0 -cleng 200 -lleng 500 -negative $negative -resample $resample -ignore_none 0 -iter $IterNum -alpha 0.025 -normL 0 -debug 1 -dropout $dropout -instances 530767 -test_instances 3423 -val_instances 380 -special_none 0 -error_log 1
...
# ../bin/finalExp -train /shared/data/ll2/CoType/data/intermediate/KBP/train.data -test /shared/data/ll2/CoType/data/intermediate/KBP/eva.data -val /shared/data/ll2/CoType/data/intermediate/KBP/val.data -threads 40 -none_idx 6 -cleng 200 -lleng 500 -negative 10 -resample 15 -ignore_none 0 -iter 100 -alpha 0.025 -normL 0 -debug 1 -dropout 0.6 -instances 225977 -test_instances 1900 -val_instances 211 -special_none 1
