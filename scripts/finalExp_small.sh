...
# echo 'small'
count=0
for IterNum in 50 70 100 130
do
	for resample in 15
	do
		for negative in 10 5 20
		do
			for dropout in 0.3 0.4 0.6
			do
			# for learning_rate in 0.025 0.0125 0.008
			# do
				# echo $IterNum " " $negative " " $resample " " $dropout " " $count " in 54 "
			...
			# echo "kl:"
				...
				../bin/finalExp -train /shared/data/ll2/CoType/data/intermediate/KBP/train.data -test /shared/data/ll2/CoType/data/intermediate/KBP/eva.data -val /shared/data/ll2/CoType/data/intermediate/KBP/val.data -threads 40 -none_idx 6 -cleng 100 -lleng 300 -negative $negative -resample $resample -ignore_none 0 -iter $IterNum -alpha 0.025 -normL 0 -debug 2 -dropout $dropout -instances 225977 -test_instances 1900 -val_instances 211 -special_none 0 -lambda6 0.1
