...
do
	...
	do
		...
		do
			...
			>&2 echo $count " in 40 "
			# echo "kl:"
			../bin/modify -train /shared/data/ll2/CoType/data/intermediate/KBP/train.data -test /shared/data/ll2/CoType/data/intermediate/KBP/test.data -threads 20 -NONE_idx 6 -cleng 30 -lleng 50 -lambda2 $lambda2 -resample $resample -ignore_none 0 -iter $IterNum -alpha 0.025 -normL 2 -debug 1
			# echo "margin:"
